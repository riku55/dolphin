...
class SettingsFragmentPresenter(
    ...
    private fun addRetroAchievementsSettings(sl: ArrayList<SettingsItem>) {
        ...
        sl.add(
            SwitchSetting(
                context,
                BooleanSetting.RETROACHIEVEMENTS_ACHIEVEMENTS_ENABLE,
        ...
        sl.add(
            SwitchSetting(
                context,
                BooleanSetting.RETROACHIEVEMENTS_LEADERBOARDS_ENABLE,
                R.string.leaderboards_enabled,
                0
            )
        )
        sl.add(
            SwitchSetting(
                context,
                BooleanSetting.RETROACHIEVEMENTS_RICH_PRESENCE_ENABLE,
                R.string.rich_presence_enabled,
                0
            )
        )
        sl.add(
        ...
        sl.add(
            SwitchSetting(
                context,
                BooleanSetting.RETROACHIEVEMENTS_BADGES_ENABLE,
                R.string.badges_enabled,
                0
            )
        )
        sl.add(
